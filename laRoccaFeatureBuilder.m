...
elseif( feature_type == 1 )
    ...
    % peek at data
    data_peek = laRoccaFeature(file_list{1});
    ...
    parfor n=1:n_subjects
        channel_data = laRoccaFeature(file_list{n});
        ...
        output_data(:,:,:,n) = data_temp;
        % a0 = toc;
        % fprintf('Generated COH features in %f seconds.\n',a0);
    end
elseif( feature_type == 0 )
    fprintf('Building PSD features.\n');
    % Rocca Filter Prep
    hann_win = hann(100);
    overlap = 50;
    nfft = 100;
    ...
    parfor n=1:n_subjects
        ...
        % a0 = toc;
        % fprintf('Generated PSD features in %f seconds.\n',a0);
    end
else
